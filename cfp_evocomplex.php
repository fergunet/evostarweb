<?php include('header.php') ?>
        ...
        <h2>Evo<span class="red">COMPLEX</span><h2>
   </div>
...
<li>chaotic systems- self-organizing systems, such as e.g., multiagent systems, social systems, etc.</li>
<li>iterated function systems and cellular automata</li>
<li>multi-scale, multi-physics and multi-goal systems</li>
<li>other complex systems not included above</li>
</ul>
</p>
<p>
...
<ul>
<li>complex population structures</li>
<li>synergy of component algorithms</li>
<li>self-organized criticality and emergent behavior</li>
<li>attractors</li>
<li>convergence, computational complexity and stopping conditions</li>
<li>other applications of complex systems to EAs.</li>
</ul>
