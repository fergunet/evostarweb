...
<li><a href="pdfs/EuroGP2017_flier.pdf">Download flyer</a></li>
</ul>
...
<p><strong>Title:</strong> Evolutionary Program Sketching

<br/><strong>Authors:</strong> Iwo Błądek, Krzysztof Krawiec

<br/><strong>Abstract:</strong> Program synthesis can be posed as a satisfiability problem and approached
...
</p><p><strong>Title:</strong> Exploring Fitness and Edit Distance of Mutated Python Programs

<br/><strong>Authors:</strong> Saemundur O. Haraldsson, John R. Woodward, Alexander I.E. Brownlee,

David Cairns

<br/><strong>Abstract:</strong> Genetic Improvement (GI) is the process of using computational search
...
</p><p><strong>Title:</strong> Differentiable Genetic Programming

<br/><strong>Authors:</strong> Dario Izzo, Francesco Biscani, Alessio Mereta

<br/><strong>Abstract:</strong> We introduce the use of high order automatic differentiation, implemented
...
</p><p><strong>Title:</strong> Evolving Game State Features from Raw Pixels

<br/><strong>Authors:</strong> Baozhu Jia, Marc Ebner

<br/><strong>Abstract:</strong> General video game playing is the art of designing artificial intelligence
...
</p><p><strong>Title:</strong> Emergent Tangled Graph Representations for Atari Game Playing Agents

<br/><strong>Authors:</strong> Stephen Kelly, Malcolm I. Heywood

<br/><strong>Abstract:</strong> Organizing code into coherent programs and relating different programs to
...
</p><p><strong>Title:</strong> A General Feature Engineering Wrapper for Machine Learning Using ε-Lexicase

Survival

<br/><strong>Authors:</strong> William La Cava, Jason Moore

<br/><strong>Abstract:</strong> We propose a general wrapper for feature learning that interfaces with other
...
</p><p><strong>Title:</strong> Visualising the Search Landscape of the Triangle Program

<br/><strong>Authors:</strong> William B. Langdon, Nadarajen Veerapen, Gabriela Ochoa

<br/><strong>Abstract:</strong> High order mutation analysis of a software engineering benchmark,
...
</p><p><strong>Title:</strong> RANSAC-GP: Dealing with Outliers in Symbolic Regression with Genetic

Programming

<br/><strong>Authors:</strong> Uriel López, Leonardo Trujillo, Yuliana Martinez, Pierrick Legrand, Enrique

Naredo, Sara Silva

<br/><strong>Abstract:</strong> Genetic programming (GP) has been shown to be a powerful tool for
...
</p><p><strong>Title:</strong> Symbolic Regression on Network Properties

<br/><strong>Authors:</strong> Marcus Märtens, Fernando Kuipers, Piet Van Mieghem

<br/><strong>Abstract:</strong> Networks are continuously growing in complexity, which creates challenges
...
</p><p><strong>Title:</strong> Evolving Time-Invariant Dispatching Rules in Job Shop Scheduling with Genetic

Programming

<br/><strong>Authors:</strong> Yi Mei, Su Nguyen, Mengjie Zhang

<br/><strong>Abstract:</strong> Genetic Programming (GP) has achieved success in evolving dispatching
...
</p><p><strong>Title:</strong> Strategies for Improving the Distribution of Random Function Outputs in GSGP

<br/><strong>Authors:</strong> Luiz Otavio V. B. Oliveira, Felipe Casadei, Gisele Pappa

<br/><strong>Abstract:</strong> In the last years, different approaches have been proposed to introduce
...
</p><p><strong>Title:</strong> Synthesis of Mathematical Programming Constraints with Genetic Programming

<br/><strong>Authors:</strong> Tomasz P. Pawlak, Krzysztof Krawiec

<br/><strong>Abstract:</strong> We identify a novel application of Genetic Programming to automatic
...
</p><p><strong>Title:</strong> Grammatical Evolution of Robust Controller Structures using Wilson Scoring

and Criticality Ranking

<br/><strong>Authors:</strong> Elias Reichensdörfer, Dirk Odenthal, Dirk Wollherr

<br/><strong>Abstract:</strong> In process control it is essential that disturbances and parameter
...
</p><p><strong>Title:</strong> Using Feature Clustering for GP-Based Feature Construction on High-
Dimensional Data

<br/><strong>Authors:</strong> Binh Tran, Bing Xue, Mengjie Zhang

<br/><strong>Abstract:</strong> Feature construction is a pre-processing technique to create new features
...
</p><p><strong>Title:</strong> Geometric Semantic Crossover with an Angle-aware Mating Scheme in Genetic

Programming for Symbolic Regression

<br/><strong>Authors:</strong> Qi Chen, Bing Xue, Yi Mei, Mengjie Zhang

<br/><strong>Abstract:</strong> Recent research shows that incorporating semantic knowledge into the
...
</p><p><strong>Title:</strong> RECIPE: A Grammar-based Framework for Automatically Evolving

Classification Pipelines

<br/><strong>Authors:</strong> Alex G. C. de Sá, Walter José G. S. Pinto, Luiz Otavio V. B. Oliveira, Gisele

Pappa

<br/><strong>Abstract:</strong> Automatic Machine Learning is a growing area of machine learning that has
...
</p><p><strong>Title:</strong> A Grammar Design Pattern for Arbitrary Program Synthesis Problems in Genetic

Programming

<br/><strong>Authors:</strong> Stefan Forstenlechner, David Fagan, Miguel Nicolau, Michael O'Neill

<br/><strong>Abstract:</strong> Grammar Guided Genetic Programming has been applied to many problem
...
</p><p><strong>Title:</strong> Improving the Tartarus Problem as a Benchmark in Genetic Programming

<br/><strong>Authors:</strong> Thomas D. Griffiths, Anikó Ekárt

<br/><strong>Abstract:</strong> For empirical research on computer algorithms, it is essential to have a set
...
</p><p><strong>Title:</strong> A New Subgraph Crossover for Cartesian Genetic Programming

<br/><strong>Authors:</strong> Roman Kalkreuth, Günter Rudolph, Andre Droschinsky

<br/><strong>Abstract:</strong> While tree-based Genetic Programming is often used with crossover,
...
</p><p><strong>Title:</strong> A Comparative Study of Different Grammar-based Genetic Programming

Approaches

<br/><strong>Authors:</strong> Nuno Lourenço, Joaquim Ferrer, Francisco B. Pereira, Ernesto Costa

<br/><strong>Abstract:</strong> Grammars are useful formalisms to specify constraints, and not
...
</p><p><strong>Title:</strong> A Comparative Analysis of Dynamic Locality and Redundancy in Grammatical

Evolution

<br/><strong>Authors:</strong>Eric Medvet

<br/><strong>Abstract:</strong> The most salient feature of Grammatical Evolution (GE) is a procedure
...
</p><p><strong>Title:</strong> On Evolutionary Approximation of Sigmoid Function for HW/SW Embedded

Systems

<br/><strong>Authors:</strong> Milos Minarik, Lukas Sekanina

<br/><strong>Abstract:</strong> Providing machine learning capabilities on low cost electronic devices is a
